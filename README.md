...
A [Live Demo](https://brakmic.github.io/microapp-demo) is also available. Of course, this demo is only showcasing the app itself without the FlyWeb environment.
