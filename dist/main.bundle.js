...
/***/ "./src/app/main/microapp.html":
/***/ function(module, exports) {

module.exports = "<!-- This is the HTML where the MicroApp will hook into -->\r\n<!DOCTYPE html>\r\n<html lang=\"en\">\r\n    <head>\r\n        <title></title>\r\n        <meta charset=\"UTF-8\">\r\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\r\n        <link rel=\"stylesheet\" href=\"style.css\">\r\n    </head>\r\n    <body>\r\n        <div id=\"micro-app\"></div> <!-- micro-app hook -->\r\n        <script src=\"microapp.js\"></script> <!-- micro-app script -->\r\n    </body>\r\n</html>"
...
"use strict";
"use strict";
var parse = __webpack_require__("./node_modules/url-parse/index.js");
var html = __webpack_require__("./src/app/main/microapp.html");
var bows = __webpack_require__("./src/platform/helpers/bows-alt.js");
...
*/
var doFetch = function (event, path, contentType) {
    fetch(BASE_URL + path)
...
exports.default = (function () {
    var name = "FlyAmp_" + counter++;
    var logger = bows(name);
    navigator.publishServer(name, undefined).then(function (server) {
        server.onfetch = function (event) {
            var headers = { 'Content-Type': 'text/html' };
            var url = parse(event.request.url);
            ...
            switch (url.pathname) {
                ...
                default: {
                    event.respondWith(new Promise(function (resolve, reject) {
                        resolve(new Response(html, { headers: headers }));
                    }));
                }
            }
        };
...
/***/ "./src/platform/helpers/bows-alt.js":
/***/ function(module, exports, __webpack_require__) {
...
(function() {
  ...
  var inNode = typeof window === 'undefined',
      ...
      debug = ls[debugKey],
      logger = __webpack_require__("./node_modules/andlog/andlog.js"),
